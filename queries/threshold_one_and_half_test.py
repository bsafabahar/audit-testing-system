"""
آزمون یک‌ونیم برابر
Ratio Analysis / 1.5 Multiple Test

شناسایی موارد با ضریب ۱.۵ از میانگین (موارد بالاتر).
"""
...
def define() -> QueryDefinition:
    ...
    parameters = [
        ...
        param_number('multiplier', 'ضریب', default_value=1.5),
    ...
    result_schema = schema(
        ...
        col('ExcessAmount', 'مبلغ اضافی', 'currency'),
        col('Multiplier', 'ضریب', 'number'),
...
def execute(session: ReadOnlySession) -> List[Dict[str, Any]]:
    ...
    for t in results:
        ...
        if amount > threshold:
            ...
            actual_multiplier = amount / average if average > 0 else 0
