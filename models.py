...
class CheckPayables(Base, SoftDeleteMixin):
    ...
    PayeeCode = Column(String, comment='کد دریافت‌کننده چک')
    PayeeName = Column(String, comment='نام دریافت‌کننده چک')
    CreationTime = Column(DateTime, nullable=False)
    CreatorUserId = Column(BigInteger)
    LastModificationTime = Column(DateTime)
    LastModifierUserId = Column(BigInteger)
...
class AssetAdditions(Base, SoftDeleteMixin):
    ...
    UtilizationDate = Column(DateTime, nullable=False, comment='تاریخ بهره‌برداری')
    ...
    TotalCost = Column(Numeric(18, 2), nullable=False, comment='بهای تمام‌شده')
    CreationTime = Column(DateTime, nullable=False)
    CreatorUserId = Column(BigInteger)
    LastModificationTime = Column(DateTime)
    LastModifierUserId = Column(BigInteger)
...
class PurchaseReceipts(Base, SoftDeleteMixin):
    ...
    UnitPrice = Column(Numeric(18, 2), nullable=False, comment='نرخ')
    Amount = Column(Numeric(18, 2), nullable=False, comment='مبلغ')
    SupplierCode = Column(String, comment='کد تأمین‌کننده (بستانکاران)')
    SupplierName = Column(String, comment='نام تأمین‌کننده (بستانکاران)')
    CreationTime = Column(DateTime, nullable=False)
    CreatorUserId = Column(BigInteger)
    LastModificationTime = Column(DateTime)
    LastModifierUserId = Column(BigInteger)
...
class PayrollTransactions(Base, SoftDeleteMixin):
    ...
    OvertimeHours = Column(Numeric(18, 2), nullable=False, comment='اضافه‌کار (ساعت)')
    ...
    OvertimePay = Column(Numeric(18, 2), nullable=False, comment='اضافه‌کاری')
    NightShiftPay = Column(Numeric(18, 2), nullable=False, comment='شب‌کاری')
    ShiftPay = Column(Numeric(18, 2), nullable=False, comment='نوبت‌کاری')
